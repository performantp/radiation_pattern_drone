...
#define TAB_COLOUR INITR_BLACKTAB       //OK
//#define TAB_COLOUR INITR_GREENTAB2    //ORIG
...
#define TFT_CS  10  // Chip select control pin  //ORIG 9
#define TFT_DC  9  // Data Command control pin  //ORIG 8
#define TFT_RST 8  // Reset pin (could connect to Arduino RESET pin) //ORIG 7
